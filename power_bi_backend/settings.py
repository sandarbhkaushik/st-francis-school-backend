"""
Django settings for power_bi_backend project.
...
ROOT_URLCONF = 'power_bi_backend.urls'
...
SITE_ID = 1
WSGI_APPLICATION = 'power_bi_backend.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        # remove comment to access swagger
